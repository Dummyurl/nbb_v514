...
<div class="title_bg">
    ...
    <div class="title">Nạp thẻ >> VTC</div>
    <div class="nr">
...
<div class="pad10">
    ...
    <?php } ?>
    <?php if ($khuyenmai_vtc > 0) { ?>
    	<p align="center">Gcoin khi nạp thẻ VTC được nhiều hơn <?php echo $khuyenmai_vtc; ?> %</p>
    <?php } ?>
    	<table width="100%" border="0" bgcolor="#9999FF">
		  <tr bgcolor="#FFFFFF">
		    <th scope="col" align="center">Thẻ VTC Online (VNĐ)</th>
...
<?php } ?>
		...
		<form id="vpoint_vtc" name="vpoint_vtc" method="post" action="index.php?mod=napthe&act=vtc">
...
<?php } ?>
			...
			<tr>
				...
				<td><input name="card_serial" id="card_serial" value="PM"> <label id="msg_card_serial" class="msg"></label></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><input type="submit" name="Submit" value="Nạp thẻ VTC Online" onclick="return btn_check_thevtc();" /></td>
			</tr>
		  </table>
		  <input type="hidden" name="action" value="vpoint_vtc" />
	  </form>
