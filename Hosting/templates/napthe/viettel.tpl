...
<div class="title_bg">
    ...
    <div class="title">Nạp thẻ >> Viettel</div>
    <div class="nr">
...
<div class="pad10">
	...
	<?php if ($khuyenmai == 1) { ?>
    	<p align="center">Gcoin khuyến mại: <?php echo $khuyenmai_phantram; ?> %
            <br />
    ...
    <?php } ?>
    	<table width="100%" border="0" bgcolor="#9999FF">
		  <tr bgcolor="#FFFFFF">
		    <th scope="col" align="center">Thẻ Viettel (VNĐ)</th>
...
<?php } ?>
		...
		<form id="vpoint_viettel" name="vpoint_viettel" method="post" action="index.php?mod=napthe&act=viettel">
...
<?php } ?>
			...
			<tr>
	    		...
	    		<td><input type="password" name="card_num" id="card_num" onfocus="focus_so(this.value,'msg_'+this.name);" onkeyup="check_so(this.value,'msg_'+this.name)" > <label id="msg_card_num" class="msg"></label></td>
			</tr>
			<tr>
				<td align="right">Nhập Serial</td>
				<td><input name="card_serial" id="card_serial" onfocus="focus_so(this.value,'msg_'+this.name);" onkeyup="check_so(this.value,'msg_'+this.name)" > <label id="msg_card_serial" class="msg"></label></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><input type="submit" name="Submit" value="Nạp thẻ Viettel" /></td>
			</tr>
		  </table>
		  <input type="hidden" name="action" value="vpoint_viettel" />
	  </form>
