...
<div class="title_bg">
    ...
    <div class="title">Nạp thẻ >> MobiFone</div>
    <div class="nr">
...
<div class="pad10">
    ...
    <?php } ?>
    	<table width="100%" border="0" bgcolor="#9999FF">
		  <tr bgcolor="#FFFFFF">
		    <th scope="col" align="center">Thẻ MobiFone (VNĐ)</th>
...
<?php } ?>
		...
		<form id="vpoint_vtc" name="vpoint_vtc" method="post" action="index.php?mod=napthe&act=mobi">
...
<?php } ?>
			...
			<tr>
				<td>&nbsp;</td>
				<td><input type="submit" name="Submit" value="Nạp thẻ MobiFone" /></td>
			</tr>
		  </table>
		  <input type="hidden" name="action" value="nap_mobi" />
	  </form>
