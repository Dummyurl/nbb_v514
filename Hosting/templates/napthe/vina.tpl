...
<div class="title_bg">
    ...
    <div class="title">Nạp thẻ >> VinaPhone</div>
    <div class="nr">
...
<div class="pad10">
    ...
    <?php } ?>
    	<table width="100%" border="0" bgcolor="#9999FF">
		  <tr bgcolor="#FFFFFF">
		    <th scope="col" align="center">Thẻ VinaPhone (VNĐ)</th>
...
<?php } ?>
		...
		<form id="vpoint_vtc" name="vpoint_vtc" method="post" action="index.php?mod=napthe&act=vina">
...
<?php } ?>
			...
			<tr>
	    		...
	    		<td><input type="password" name="card_num" id="card_num" maxlength="14" onfocus="focus_so(this.value,'msg_'+this.name);" onkeyup="check_so(this.value,'msg_'+this.name)" > <label id="msg_card_num" class="msg"></label></td>
			</tr>
			<tr>
				<td align="right">Nhập Serial</td>
				<td><input name="card_serial" id="card_serial" /> <label id="msg_card_serial" class="msg"></label></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><input type="submit" name="Submit" value="Nạp thẻ VinaPhone" /></td>
			</tr>
		  </table>
		  <input type="hidden" name="action" value="nap_vina" />
	  </form>
