...
<div class="title_bg">
    ...
    <div class="title">Tiền Tệ >> Đổi Gcoin sang Vpoint</div>
    <div class="nr">
...
<form id="gcoin2vpoint" name="gcoin2vpoint" method="post" action="index.php?mod=tiente&act=gcoin2vpoint">
				<center><b>Tỷ giá : 1 Gcoin = 1 V.Point</b></center>
    	<table width="100%" border="0" cellpadding="1" cellspacing="1">
			...
			<tr>
				<td>&nbsp;</td>
				<td><input type="submit" name="Submit" value="Đổi Gcoin sang V.Point" /></td>
			</tr>
	  	</table>
