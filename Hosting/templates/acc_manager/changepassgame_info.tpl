...
<div class="title_bg">
    ...
    <div class="title">Đổi mật khẩu Game - Dùng Thông tin Tài Khoản</div>
    <div class="nr">
...
<form id="changepassgame" name="changepassgame" method="post" action="index.php?mod=acc_manager&act=changepassgame_info">
