...
if ($Use_CardVTCOnline != 1) {
	...
	if (isset($_POST['action']))
	{
		...
		if ($action == 'vpoint_vtc')
		{
			...
			{
				$notice = "Chưa chọn mệnh giá thẻ VTC";
			}
			...
			elseif (empty($card_serial)) {
				$notice = "Chưa điền Serial thẻ VTC";
			}
	...
	if ( $khuyenmai_vtc > 0) {
		$menhgia10000 = $menhgia10000*(1+($khuyenmai_vtc/100));
		$menhgia20000 = $menhgia20000*(1+($khuyenmai_vtc/100));
		$menhgia30000 = $menhgia30000*(1+($khuyenmai_vtc/100));
		$menhgia50000 = $menhgia50000*(1+($khuyenmai_vtc/100));
		$menhgia100000 = $menhgia100000*(1+($khuyenmai_vtc/100));
		$menhgia200000 = $menhgia200000*(1+($khuyenmai_vtc/100));
		$menhgia300000 = $menhgia300000*(1+($khuyenmai_vtc/100));
		$menhgia500000 = $menhgia500000*(1+($khuyenmai_vtc/100));
	}
	...
	$page_template = "templates/napthe/vtc.tpl";
}
?>