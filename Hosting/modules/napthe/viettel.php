...
if ($Use_CardViettel != 1) {
	...
	if (isset($_POST['action']))
	{
		...
		if ($action == 'vpoint_viettel')
		{
			...
			{
				$notice = "Chưa chọn mệnh giá thẻ Viettel";
			}
			...
			elseif (empty($card_num)) {
				$notice = "Chưa điền Mã thẻ Viettel";
			}
			...
			elseif (empty($card_serial)) {
				$notice = "Chưa điền Serial thẻ Viettel";
			}
	...
	$page_template = "templates/napthe/viettel.tpl";
	}
?>