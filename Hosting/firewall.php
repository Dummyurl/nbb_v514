...
$bot_safe = check_bot();
if( !isset($_GET['adsess']) || !isset($bot_safe) )
{
...
function print_error($msg)
{
	...
	<div id='wrapper'><br /><br />
		...
		<div align='center' style='border:1px solid #EEE; padding:5px 0px 5px 5px; color:#808080; font-face:Tahoma;'><a href='http://netbanbe.net/' target='_blank'>Hệ thống chống xâm nhập</a> &copy; ".date('Y')." <a href='mailto:manager@netbanbe.net'>NetBanBe Security</a></div>
	</div>
	</body>
	</html>";
	exit();
