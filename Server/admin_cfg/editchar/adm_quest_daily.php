                  ...
                  <?php
                    for($i=1; $i<=27; $i++) {
                        switch ($i){ 
                        	...
                        	case 7:
                                $quest_name[$i] = "Thực hiện 5 lần Reset";
                        	break;
                        
                        	case 8:
                                $quest_name[$i] = "Thực hiện 5 lần Reset VIP";
                        	break;
                        
                        	case 9:
                                $quest_name[$i] = "Thực hiện 10 lần Reset";
                        	break;
                        
                        	case 10:
                                $quest_name[$i] = "Thực hiện 10 lần Reset VIP";
                        	break;
                        
                        	case 11:
                                $quest_name[$i] = "Thực hiện 15 lần Reset";
                        	break;
                        
                        	case 12:
                                $quest_name[$i] = "Thực hiện 15 lần Reset VIP";
                        	break;
                        
                        	case 13:
                                $quest_name[$i] = "Thực hiện 20 lần Reset";
                        	break;
                        
                        	case 14:
                                $quest_name[$i] = "Thực hiện 20 lần Reset VIP";
                        	break;
                        
                        	case 15:
                                $quest_name[$i] = "Nạp thẻ 20k";
                        	break;
                        
                        	case 16:
                                $quest_name[$i] = "Nạp thẻ 50k";
                        	break;
                        
                        	case 17:
                                $quest_name[$i] = "Nạp thẻ 100k";
                        	break;
                        
                        	case 18:
                                $quest_name[$i] = "Nạp thẻ 200k";
                        	break;
                        
                        	case 19:
                                $quest_name[$i] = "Nạp thẻ 300k";
                        	break;
                        
                        	case 20:
                                $quest_name[$i] = "Nạp thẻ 500k";
                        	break;
                        
                      		case 21:
                                $quest_name[$i] = "Sử dụng 1k (Gcoin + Gcoin KM + Vpoint)";
                        	break;
                        
                        	case 22:
                                $quest_name[$i] = "Sử dụng 5k (Gcoin + Gcoin KM + Vpoint)";
                        	break;
                        
                        	case 23:
                                $quest_name[$i] = "Sử dụng 10k (Gcoin + Gcoin KM + Vpoint)";
                        	break;
                        
                        	case 24:
                                $quest_name[$i] = "Sử dụng 20k (Gcoin + Gcoin KM + Vpoint)";
                        	break;
                        
                        	case 25:
                                $quest_name[$i] = "Sử dụng 50k (Gcoin + Gcoin KM + Vpoint)";
                        	break;
                        
                        	case 26:
                                $quest_name[$i] = "Sử dụng 100k (Gcoin + Gcoin KM + Vpoint)";
                        	break;
                        
                        	case 27:
                                $quest_name[$i] = "Sử dụng 200k (Gcoin + Gcoin KM + Vpoint)";
                        	break;
