...
if($action == 'edit')
{
	...
	$phut_1point 	= $_POST['phut_1point'];
        $phut_1point = abs(intval($phut_1point));
    		$content .= "\$phut_1point	= $phut_1point;\n";
	$uythacoff_price 	= $_POST['uythacoff_price'];
        $uythacoff_price = abs(intval($uythacoff_price));
...
<?php if($notice) echo $notice; ?>
				...
				<table>
					...
					<tr>
						<td>Chi phí: </td>
						<td><input type="text" name="uythacoff_price" value="<?php echo $uythacoff_price; ?>" size="5"/> Gcoin / 1 phút Ủy Thác Offline</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
