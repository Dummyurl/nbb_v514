...
$file_edit = 'config/config_lockitem.php';
...
if($action == 'edit')
{
	...
	$lockitem_gcoin 	= $_POST['lockitem_gcoin'];
        $lockitem_gcoin = abs(intval($lockitem_gcoin));
    		$content .= "\$lockitem_gcoin	= $lockitem_gcoin;\n";
...
<?php if($notice) echo $notice; ?>
				...
				<center>Chi phí Bảo vệ Item : <input type="text" name="lockitem_gcoin" value="<?php echo $lockitem_gcoin; ?>" size="5"/> Gcoin<br />
