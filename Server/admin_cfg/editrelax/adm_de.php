...
$file_edit = 'config/config_relax_de.php';
...
if($action == 'edit')
{
	...
	$de_win = $_POST['de_win'];
        $de_win = abs(intval($de_win));
    		$content .= "\$de_win	= $de_win;\n";
...
<?php if($notice) echo $notice; ?>
				...
				<table>
					<tr>
						<td align="right">Giải thưởng đề x </td>
						<td><input type="text" name="de_win" value="<?php echo $de_win; ?>" size="10"/> lần</td>
					</tr>
