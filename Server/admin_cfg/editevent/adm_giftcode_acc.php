...
$file_edit = 'config/config_giftcode_acc.php';
...
if($action == 'edit')
{
	...
	$giftcode_acc_use = $_POST['giftcode_acc_use'];
        $giftcode_acc_use = abs(intval($giftcode_acc_use));
    		$content .= "\$giftcode_acc_use	= '$giftcode_acc_use';\n";
...
<?php if($notice) echo $notice; ?>
				...
				<table>
					<tr><td colspan="2">GiftCode Acc là GiftCode được tạo ra cố định cho 1 tài khoản. Chỉ tài khoản đó mới được nhận quà.</td></tr>
                    <tr>
						<td width="200" align='right'>Sử dụng GiftCode Tuần: </td>
						<td>
                            <select name="giftcode_acc_use">
                                <option value="0" <?php if($giftcode_acc_use == 0) echo "selected='selected'"; ?> >Không</option>
                                <option value="1" <?php if($giftcode_acc_use == 1) echo "selected='selected'"; ?> >GiftCode ngẫu nhiên loại 1</option>
                                <option value="2" <?php if($giftcode_acc_use == 2) echo "selected='selected'"; ?> >GiftCode ngẫu nhiên loại 2</option>
                                <option value="3" <?php if($giftcode_acc_use == 3) echo "selected='selected'"; ?> >GiftCode ngẫu nhiên loại 3</option>
                              </select>
                        </td>
					</tr>
