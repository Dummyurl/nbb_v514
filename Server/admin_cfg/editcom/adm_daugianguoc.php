...
$file_edit = 'config/config_daugianguoc.php';
...
<?php if($notice) echo $notice; ?>
				...
				<table>
					<tr>
						<td width="200" align="right">Sử dụng Đấu Giá Ngược: </td>
                        
						<td><input type="checkbox" name="Use_DauGiaNguoc" value="1" <?php if($Use_DauGiaNguoc == 1) echo "checked"; ?>/></td>
					</tr>
					<tr>
						<td align="right">Chi phí cho 1 lần đấu giá: </td>
						<td><input type="text" name="Vpoint_Bid" value="<?php echo $Vpoint_Bid; ?>" /> Vpoint</td>
					</tr>
