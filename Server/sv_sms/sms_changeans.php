...
$get_info = $get_info_result->fetchrow();
    ...
    //Ghi vào Log
        ...
        $log_price = "-";
        $log_Des = "$taikhoan Đổi Câu trả lời bí mật từ ". $get_info[2] ." sang ". $ansnew ." qua SMS";
        $log_time = $timestamp;
...
$update = $db->Execute("Update MEMB_INFO SET fpas_answ='$ansnew' WHERE memb___id='$taikhoan'");
 	//Delete Data
		$del_data = $db->Execute("DELETE FROM SMS WHERE Code='$code'");
 	$content = "Cau tra loi bi mat da thay doi thanh cong.";
?>