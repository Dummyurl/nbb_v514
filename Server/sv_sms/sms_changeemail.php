...
$get_info = $get_info_result->fetchrow();
    ...
    //Ghi vào Log
        ...
        $log_price = "-";
        $log_Des = "$taikhoan Đổi Email từ ". $get_info[0] ." sang ". $emailnew ." qua SMS";
        $log_time = $timestamp;
...
$update = $db->Execute("Update MEMB_INFO SET mail_addr='$emailnew' WHERE memb___id='$taikhoan'");
 	//Delete Data
		$del_data = $db->Execute("DELETE FROM SMS WHERE Code='$code'");
 	$content = "Dia chi Email da thay doi thanh $emailnew.";
?>