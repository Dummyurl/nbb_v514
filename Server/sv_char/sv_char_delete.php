...
if ($ktvpoint < 0){ 
 echo "Bạn có $vpoint[0] V.Point. Bạn cần $deletechar_vpoint V.Point để xóa nhân vật."; exit();
}
...
if ($char_index) {
    ...
    echo "Có lỗi trong quá trình xóa nhân vật. Liên hệ Admin để được hỗ trợ."; exit();
}
