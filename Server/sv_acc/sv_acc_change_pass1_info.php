...
$pass1new_md5 = md5($pass1new);
	...
	$update_pass1_query = "UPDATE MEMB_INFO SET memb__pwd2='$pass1new', memb__pwdmd5='$pass1new_md5' WHERE memb___id='$login'";
    ...
    //Ghi vào Log
        ...
        $log_price = "-";
        $log_Des = "$login Đổi mật khẩu Cấp 1 sang $pass1new";
        $log_time = $timestamp;
	...
	echo "Đổi Mật khẩu Cấp 1 thành : <b>$pass1new</b> thành công.";
}
