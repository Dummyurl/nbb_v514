...
if($ans != $get_info[2])
{
    ...
    $update_sno_query = "UPDATE MEMB_INFO SET sno__numb='$sno__numb' WHERE memb___id='$login'";
	$update_sno_result = $db->Execute($update_sno_query);
    ...
    //Ghi vào Log
        ...
        $log_price = "-";
        $log_Des = "$login Đổi 7 Mã bí mật sang $snonumb";
        $log_time = $timestamp;
	...
	echo "Đổi 7 Số bí mật thành : <b>$snonumb</b> thành công.";
}
