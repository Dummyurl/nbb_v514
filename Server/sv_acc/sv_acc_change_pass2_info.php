...
$update_pass2_query = "UPDATE MEMB_INFO SET pass2='$pass2new' WHERE memb___id='$login'";


	$update_pass2_result = $db->Execute($update_pass2_query);
    ...
    //Ghi vào Log
        ...
        $log_price = "-";
        $log_Des = "$login Đổi Mật khẩu Cấp 2 từ $pass2 sang $pass2new";
        $log_time = $timestamp;
	...
	echo "Đổi Mật khẩu Cấp 2 thành : <b>$pass2new</b> thành công.";
}
